export class OptimizeIndex1683682889966 {
	...
	async up(queryRunner) {
			...
			await queryRunner.query(`CREATE INDEX "IDX_DRIVE_FILE_USER_FOLDER" ON "drive_file" ("userId", "folderId")`)
	}

	async down(queryRunner) {
			await queryRunner.query(`DROP INDEX "IDX_NOTE_FILE_IDS"`)
			await queryRunner.query(`DROP INDEX "IDX_DRIVE_FILE_USER_FOLDER"`)
