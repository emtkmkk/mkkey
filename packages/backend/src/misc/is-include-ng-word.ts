export function isIncludeNgWord(note: any): string {
	...
	const ngword1 = ["ちんちん", "ちんぽ", "ちんこ", "うんこ", "うんち", "おしっこ", "ぱいぱい", "きんたま", "おっぱい", "ぱいおつ", "乳首", "ちくび"]
	const ngword2 = ["おなほ", "ぱいずり", "射精", "しゃせい", "おなに", "精液", "せいえき", "まんこ", "ふたなり", "れいぷ", "せっくす", "せくーす", "ヴぁぎな", "しこっ", "性器", "処女", "受精", "自慰", "勃起"];
