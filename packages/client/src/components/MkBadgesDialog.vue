...
const badgeDescriptions: Record<string, string> = {
	star: "一度でもパワーが★ランクに到達すると付与される。",
	mkhb: "旧サーバーから移住した方に付与される。",
	mkb1: "サーバーを支援してくださった事がある方に付与される。",
	mkb2: "サーバーを支援してくださった事がある方に付与される。",
	mkb3: "サーバーを支援してくださった事がある方に付与される。",
	mkb4: "サーバーを支援してくださった事がある方に付与される。",
	admin: "サーバーの運営・管理を行う管理人に付与される。",
	moderator: "サーバーの管理をお手伝いするモデレーターに付与される。",
};
